...
class UtilizouHoraExtra(View):
    def post(self, *args, **kwargs):
        ...
        response = json.dumps({'mensagem': 'Requisicao executada', 'horas': float(empregado.total_horas_extras)})
...
class ExportarParaCSV(View):
    def get(self, request):
        ...
        for registro in registro_he:
            writer.writerow([registro.id, registro.motivo, registro.funcionario, registro.funcionario.total_horas_extras, registro.horas])
...
class ExportarExcel(View):
    def get(self, request):
        ...
        columns = ['Id', 'Motyivo', 'Funcionario', 'Rest. Func.', 'Horas']
